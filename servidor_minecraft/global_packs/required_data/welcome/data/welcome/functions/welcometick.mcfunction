...
execute as @a[scores={welcome=1..}] at @s run tellraw @s {"text": "Welcome Back! (Press L for Quests, /trigger.. to RTP/Spawn, M for Worldmap, C for Zoom) Happy Exploring!", "color": "aqua", "bold":"true"}
